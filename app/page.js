...
export default function Home() {
  ...
  async function generate() {
    ...
    try {
      ...
      setStatus(
        data.message || "Generation request received."
      );
  ...
  return (
    <main className="shell">
      ...
      <section className="hero">
        ...
        <p className="sub">
          Describe a scene, character or story and
          generate a video from your imagination.
        </p>
      ...
      <section className="features">
        ...
        <div>
          <b>🎬 Text to Video</b>
          <p>
            Convert detailed prompts into video.
          </p>
        </div>
        ...
        <div>
          <b>📖 Story Mode</b>
          <p>
            Turn a script into multiple connected scenes.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Keep characters recognizable across scenes.
          </p>
        </div>
      ...
      <footer>
        CineAI • Admin unlimited mode • AI video
        generation engine
      </footer>
